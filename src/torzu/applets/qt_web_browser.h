...
private:
    /**
     * Handles button presses to execute functions assigned in torzu_key_callbacks.
     * torzu_key_callbacks contains specialized functions for the buttons in the window footer
     * that can be overridden by games to achieve desired functionality.
     *
     * @tparam HIDButton The list of buttons contained in torzu_key_callbacks
     */
