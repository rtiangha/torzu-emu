...
import org.torzu.torzu_emu.features.input.model.ButtonName
...
object NativeInput {
     ...
     * @param device An [InputDevice] or the input overlay wrapped with [TorzuInputDevice]
     */
    external fun registerController(device: TorzuInputDevice)
