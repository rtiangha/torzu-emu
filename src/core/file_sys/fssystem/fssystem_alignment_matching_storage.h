...
class AlignmentMatchingStorage : public IStorage {
    TORZU_NON_COPYABLE(AlignmentMatchingStorage);
    TORZU_NON_MOVEABLE(AlignmentMatchingStorage);
...
class AlignmentMatchingStoragePooledBuffer : public IStorage {
    TORZU_NON_COPYABLE(AlignmentMatchingStoragePooledBuffer);
    TORZU_NON_MOVEABLE(AlignmentMatchingStoragePooledBuffer);
