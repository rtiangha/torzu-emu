...
package org.torzu.torzu_emu.features
...
import org.torzu.torzu_emu.getPublicFilesDir

class DocumentProvider : DocumentsProvider() {
    private val baseDirectory: File
        get() = File(TorzuApplication.application.getPublicFilesDir().canonicalPath)
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        cursor.newRow().apply {
            ...
            add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_torzu)
        }
