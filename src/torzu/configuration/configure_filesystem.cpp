...
void ConfigureFilesystem::SetConfiguration() {
    ui->nand_directory_edit->setText(
        QString::fromStdString(Common::FS::GetTorzuPathString(Common::FS::TorzuPath::NANDDir)));
    ui->sdmc_directory_edit->setText(
        QString::fromStdString(Common::FS::GetTorzuPathString(Common::FS::TorzuPath::SDMCDir)));
    ui->gamecard_path_edit->setText(
        QString::fromStdString(Settings::values.gamecard_path.GetValue()));
    ui->dump_path_edit->setText(
        QString::fromStdString(Common::FS::GetTorzuPathString(Common::FS::TorzuPath::DumpDir)));
    ui->load_path_edit->setText(
        QString::fromStdString(Common::FS::GetTorzuPathString(Common::FS::TorzuPath::LoadDir)));
...
void ConfigureFilesystem::ApplyConfiguration() {
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::NANDDir,
                            ui->nand_directory_edit->text().toStdString());
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::SDMCDir,
                            ui->sdmc_directory_edit->text().toStdString());
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::DumpDir,
                            ui->dump_path_edit->text().toStdString());
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::LoadDir,
...
void ConfigureFilesystem::ResetMetadata() {
    if (!Common::FS::Exists(Common::FS::GetTorzuPath(Common::FS::TorzuPath::CacheDir) /
                            "game_list/")) {
