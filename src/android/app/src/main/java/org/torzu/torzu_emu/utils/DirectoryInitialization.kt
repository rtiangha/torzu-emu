...
import org.torzu.torzu_emu.overlay.model.OverlayControlData
import org.torzu.torzu_emu.overlay.model.OverlayControl
import org.torzu.torzu_emu.overlay.model.OverlayLayout
import org.torzu.torzu_emu.utils.PreferenceUtil.migratePreference
...
object DirectoryInitialization {
    ...
    private fun initializeInternalStorage() {
        try {
            userPath = TorzuApplication.appContext.getExternalFilesDir(null)!!.canonicalPath
    ...
    private fun migrateSettings() {
        val preferences = PreferenceManager.getDefaultSharedPreferences(TorzuApplication.appContext)
