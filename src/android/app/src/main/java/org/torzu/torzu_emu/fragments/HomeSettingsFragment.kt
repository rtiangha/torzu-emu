...
import org.torzu.torzu_emu.BuildConfig
...
import org.torzu.torzu_emu.adapters.HomeSettingAdapter
import org.torzu.torzu_emu.databinding.FragmentHomeSettingsBinding
import org.torzu.torzu_emu.features.DocumentProvider
import org.torzu.torzu_emu.features.settings.model.Settings
import org.torzu.torzu_emu.model.DriverViewModel
import org.torzu.torzu_emu.model.HomeSetting
import org.torzu.torzu_emu.model.HomeViewModel
import org.torzu.torzu_emu.ui.main.MainActivity
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList: MutableList<HomeSetting> = mutableListOf<HomeSetting>().apply {
            ...
            add(
                HomeSetting(
                    R.string.manage_torzu_data,
                    R.string.manage_torzu_data_description,
                    ...
                    R.drawable.ic_check_circle,
                    {
                        ProgressDialogFragment.newInstance(
                            ...
                            return@newInstance if (progressCallback.invoke(100, 100)) {
                                ...
                                val errorMessage = TorzuApplication.appContext.getString(
    ...
    private fun shareLog() {
        val currentLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                ...
                "${DocumentProvider.ROOT_ID}/log/torzu_log.txt"
            )
        )!!
        val oldLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                DocumentProvider.AUTHORITY,
                "${DocumentProvider.ROOT_ID}/log/torzu_log.txt.old.txt"
            )
        )!!
