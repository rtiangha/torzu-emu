...
void ConfigureWeb::RetranslateUI() {
    ...
    ui->web_signup_link->setText(
        tr("<a href='https://profile.torzu-emu.org/'><span style=\"text-decoration: underline; "
           "color:#039be5;\">Sign up</span></a>"));

    ui->web_token_info_link->setText(
        tr("<a href='https://torzu-emu.org/wiki/torzu-web-service/'><span style=\"text-decoration: "
...
void ConfigureWeb::SetConfiguration() {
    ...
    ui->edit_token->setText(QString::fromStdString(GenerateDisplayToken(
        Settings::values.torzu_username.GetValue(), Settings::values.torzu_token.GetValue())));
...
void ConfigureWeb::ApplyConfiguration() {
    ...
    if (user_verified) {
        Settings::values.torzu_username =
            UsernameFromDisplayToken(ui->edit_token->text().toStdString());
        Settings::values.torzu_token = TokenFromDisplayToken(ui->edit_token->text().toStdString());
    } else {
        QMessageBox::warning(
