...
class CompressedStorage : public IReadOnlyStorage {
    TORZU_NON_COPYABLE(CompressedStorage);
    TORZU_NON_MOVEABLE(CompressedStorage);
...
private:
    class CompressedStorageCore {
        TORZU_NON_COPYABLE(CompressedStorageCore);
        TORZU_NON_MOVEABLE(CompressedStorageCore);
    ...
    class CacheManager {
        TORZU_NON_COPYABLE(CacheManager);
        TORZU_NON_MOVEABLE(CacheManager);
