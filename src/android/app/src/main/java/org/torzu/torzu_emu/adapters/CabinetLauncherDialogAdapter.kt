...
import org.torzu.torzu_emu.databinding.DialogListItemBinding
import org.torzu.torzu_emu.model.CabinetMode
import org.torzu.torzu_emu.adapters.CabinetLauncherDialogAdapter.CabinetModeViewHolder
import org.torzu.torzu_emu.model.AppletInfo
...
class CabinetLauncherDialogAdapter(val fragment: Fragment) :
    ...
    inner class CabinetModeViewHolder(val binding: DialogListItemBinding) :
        ...
        private fun onClick(mode: CabinetMode) {
            ...
            val appletGame = Game(
                title = TorzuApplication.appContext.getString(R.string.cabinet_applet),
                path = appletPath
            )
