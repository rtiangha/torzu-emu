...
import org.torzu.torzu_emu.features.settings.model.AbstractSetting
...
abstract class SettingsItem(
    ...
    val title: String by lazy {
        if (titleId != 0) {
            return@lazy TorzuApplication.appContext.getString(titleId)
        }
    ...
    val description: String by lazy {
        if (descriptionId != 0) {
            return@lazy TorzuApplication.appContext.getString(descriptionId)
        }
