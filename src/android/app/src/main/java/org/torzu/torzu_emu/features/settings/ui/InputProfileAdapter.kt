...
import org.torzu.torzu_emu.adapters.AbstractListAdapter
import org.torzu.torzu_emu.databinding.ListItemInputProfileBinding
...
data class NewProfileItem(
    ...
    override val name: String = TorzuApplication.appContext.getString(R.string.create_new_profile)
}
