...
EmuWindow_SDL2_Null::EmuWindow_SDL2_Null(InputCommon::InputSubsystem* input_subsystem_,
    ...
    const std::string window_title = fmt::format("torzu {} | {}-{} (Vulkan)", Common::g_build_name,
    ...
    SDL_PumpEvents();
    LOG_INFO(Frontend, "torzu Version: {} | {}-{} (Null)", Common::g_build_name,
             Common::g_scm_branch, Common::g_scm_desc);
}
