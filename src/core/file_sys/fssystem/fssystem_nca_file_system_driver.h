...
class NcaReader {
    TORZU_NON_COPYABLE(NcaReader);
    TORZU_NON_MOVEABLE(NcaReader);
...
class NcaFsHeaderReader {
    TORZU_NON_COPYABLE(NcaFsHeaderReader);
    TORZU_NON_MOVEABLE(NcaFsHeaderReader);
...
class NcaFileSystemDriver {
    TORZU_NON_COPYABLE(NcaFileSystemDriver);
    TORZU_NON_MOVEABLE(NcaFileSystemDriver);
