...
#include "torzu/configuration/configure_tas.h"
...
void ConfigureTasDialog::LoadConfiguration() {
    ui->tas_path_edit->setText(
        QString::fromStdString(Common::FS::GetTorzuPathString(Common::FS::TorzuPath::TASDir)));
...
void ConfigureTasDialog::ApplyConfiguration() {
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::TASDir, ui->tas_path_edit->text().toStdString());
