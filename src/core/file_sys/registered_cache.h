...
public:
    ...
    // poses quite a challenge. Instead of creating a new meta NCA for this file, torzu will create a
    // dir inside the NAND called 'torzu_meta' and store the raw CNMT there.
...
private:
    ...
    bool RawInstallTorzuMeta(const CNMT& cnmt);
    ...
    // maps tid -> meta for CNMT in torzu_meta
    std::map<u64, CNMT> torzu_meta;
};
