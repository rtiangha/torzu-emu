...
public:
     ...
     * @param j_input_device TorzuInputDevice object from the Android frontend to register.
     */
    ...
    /**
     * Gets the axes reported by the TorzuInputDevice.
     * @param env JNI environment pointer.
     * @param j_device TorzuInputDevice from the Android frontend.
