    ...
    connect(ui->screenshot_path_button, &QToolButton::pressed, this, [this] {
        auto dir =
            QFileDialog::getExistingDirectory(this, tr("Select Screenshots Path..."),
                                              QString::fromStdString(Common::FS::GetTorzuPathString(
                                                  Common::FS::TorzuPath::ScreenshotsDir)));
        if (!dir.isEmpty()) {
...
void ConfigureUi::ApplyConfiguration() {
    ...
    Common::FS::SetTorzuPath(Common::FS::TorzuPath::ScreenshotsDir,
...
void ConfigureUi::SetConfiguration() {
    ...
    ui->screenshot_path_edit->setText(QString::fromStdString(
        Common::FS::GetTorzuPathString(Common::FS::TorzuPath::ScreenshotsDir)));
