...
static jclass s_torzu_input_device_interface;
static jmethodID s_torzu_input_device_get_name;
static jmethodID s_torzu_input_device_get_guid;
static jmethodID s_torzu_input_device_get_port;
static jmethodID s_torzu_input_device_get_supports_vibration;
static jmethodID s_torzu_input_device_vibrate;
static jmethodID s_torzu_input_device_get_axes;
static jmethodID s_torzu_input_device_has_keys;
...
jclass GetTorzuInputDeviceInterface() {
    return s_torzu_input_device_interface;
}

jmethodID GetTorzuDeviceGetName() {
    return s_torzu_input_device_get_name;
}

jmethodID GetTorzuDeviceGetGUID() {
    return s_torzu_input_device_get_guid;
}

jmethodID GetTorzuDeviceGetPort() {
    return s_torzu_input_device_get_port;
}

jmethodID GetTorzuDeviceGetSupportsVibration() {
    return s_torzu_input_device_get_supports_vibration;
}

jmethodID GetTorzuDeviceVibrate() {
    return s_torzu_input_device_vibrate;
}

jmethodID GetTorzuDeviceGetAxes() {
    return s_torzu_input_device_get_axes;
}

jmethodID GetTorzuDeviceHasKeys() {
    return s_torzu_input_device_has_keys;
}
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    const jclass native_library_class = env->FindClass("org/torzu/torzu_emu/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_disk_cache_progress_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("org/torzu/torzu_emu/disk_shader_cache/DiskShaderCacheProgress")));
    s_load_callback_stage_class = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass(
        "org/torzu/torzu_emu/disk_shader_cache/DiskShaderCacheProgress$LoadCallbackStage")));

    const jclass game_dir_class = env->FindClass("org/torzu/torzu_emu/model/GameDir");
    ...
    const jclass game_class = env->FindClass("org/torzu/torzu_emu/model/Game");
    ...
    const jclass overlay_control_data_class =
        env->FindClass("org/torzu/torzu_emu/overlay/model/OverlayControlData");
    ...
    const jclass patch_class = env->FindClass("org/torzu/torzu_emu/model/Patch");
    ...
    const jclass player_input_class =
        env->FindClass("org/torzu/torzu_emu/features/input/model/PlayerInput");
    ...
    const jclass torzu_input_device_interface =
        env->FindClass("org/torzu/torzu_emu/features/input/TorzuInputDevice");
    s_torzu_input_device_interface =
        reinterpret_cast<jclass>(env->NewGlobalRef(torzu_input_device_interface));
    s_torzu_input_device_get_name =
        env->GetMethodID(torzu_input_device_interface, "getName", "()Ljava/lang/String;");
    s_torzu_input_device_get_guid =
        env->GetMethodID(torzu_input_device_interface, "getGUID", "()Ljava/lang/String;");
    s_torzu_input_device_get_port = env->GetMethodID(torzu_input_device_interface, "getPort", "()I");
    s_torzu_input_device_get_supports_vibration =
        env->GetMethodID(torzu_input_device_interface, "getSupportsVibration", "()Z");
    s_torzu_input_device_vibrate = env->GetMethodID(torzu_input_device_interface, "vibrate", "(F)V");
    s_torzu_input_device_get_axes =
        env->GetMethodID(torzu_input_device_interface, "getAxes", "()[Ljava/lang/Integer;");
    s_torzu_input_device_has_keys =
        env->GetMethodID(torzu_input_device_interface, "hasKeys", "([I)[Z");
    env->DeleteLocalRef(torzu_input_device_interface);
...
void JNI_OnUnload(JavaVM* vm, void* reserved) {
    ...
    env->DeleteGlobalRef(s_torzu_input_device_interface);
