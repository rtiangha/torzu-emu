...
#if (QT_VERSION < QT_VERSION_CHECK(6, 0, 0)) && TORZU_USE_QT_MULTIMEDIA
#include <QCamera>
...
GRenderWindow::GRenderWindow(GMainWindow* parent, EmuThread* emu_thread_,
    ...
    setWindowTitle(QStringLiteral("torzu %1 | %2-%3")
...
#else
    QMessageBox::warning(this, tr("OpenGL not available!"),
                         tr("torzu has not been compiled with OpenGL support."));
    return false;
#endif
}
