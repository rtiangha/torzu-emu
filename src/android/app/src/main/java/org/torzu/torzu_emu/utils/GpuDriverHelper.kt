...
object GpuDriverHelper {
    ...
    fun initializeDriverParameters() {
        try {
            ...
            fileRedirectionPath = TorzuApplication.appContext
                .getExternalFilesDir(null)!!.canonicalPath + "/gpu/vk_file_redirect/"

            // Initialize the driver installation directory.
            driverInstallationPath = TorzuApplication.appContext
        ...
        hookLibPath = TorzuApplication.appContext.applicationInfo.nativeLibraryDir + "/"
