...
void LogSettings() {
    ...
    LOG_INFO(Config, "torzu Configuration:");
    for (auto& [category, settings] : values.linkage.by_category) {
        for (const auto& setting : settings) {
            if (setting->Id() == values.torzu_token.Id()) {
    ...
    log_path("DataStorage_CacheDir", Common::FS::GetTorzuPath(Common::FS::TorzuPath::CacheDir));
    log_path("DataStorage_ConfigDir", Common::FS::GetTorzuPath(Common::FS::TorzuPath::ConfigDir));
    log_path("DataStorage_LoadDir", Common::FS::GetTorzuPath(Common::FS::TorzuPath::LoadDir));
    log_path("DataStorage_NANDDir", Common::FS::GetTorzuPath(Common::FS::TorzuPath::NANDDir));
    log_path("DataStorage_SDMCDir", Common::FS::GetTorzuPath(Common::FS::TorzuPath::SDMCDir));
}
