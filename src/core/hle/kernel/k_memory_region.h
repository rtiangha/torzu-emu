...
public:
    TORZU_NON_COPYABLE(KMemoryRegion);
    TORZU_NON_MOVEABLE(KMemoryRegion);
...
public:
    TORZU_NON_COPYABLE(KMemoryRegionTree);
    TORZU_NON_MOVEABLE(KMemoryRegionTree);
...
public:
    TORZU_NON_COPYABLE(KMemoryRegionAllocator);
    TORZU_NON_MOVEABLE(KMemoryRegionAllocator);
