...
class VfsFilesystem {
public:
    TORZU_NON_COPYABLE(VfsFilesystem);
    TORZU_NON_MOVEABLE(VfsFilesystem);
...
class VfsFile {
public:
    TORZU_NON_COPYABLE(VfsFile);
    TORZU_NON_MOVEABLE(VfsFile);
...
class VfsDirectory {
public:
    TORZU_NON_COPYABLE(VfsDirectory);
    TORZU_NON_MOVEABLE(VfsDirectory);
