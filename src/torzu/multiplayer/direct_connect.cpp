...
#include "torzu/multiplayer/direct_connect.h"
...
DirectConnectWindow::DirectConnectWindow(Core::System& system_, QWidget* parent)
    ...
    if (ui->nickname->text().isEmpty() && !Settings::values.torzu_username.GetValue().empty()) {
        // Use torzu Web Service user name as nickname by default
        ui->nickname->setText(QString::fromStdString(Settings::values.torzu_username.GetValue()));
    }
