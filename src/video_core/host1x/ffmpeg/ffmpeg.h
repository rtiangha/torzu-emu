...
class Packet {
public:
    TORZU_NON_COPYABLE(Packet);
    TORZU_NON_MOVEABLE(Packet);
...
class Frame {
public:
    TORZU_NON_COPYABLE(Frame);
    TORZU_NON_MOVEABLE(Frame);
...
class Decoder {
public:
    TORZU_NON_COPYABLE(Decoder);
    TORZU_NON_MOVEABLE(Decoder);
...
class HardwareContext {
public:
    TORZU_NON_COPYABLE(HardwareContext);
    TORZU_NON_MOVEABLE(HardwareContext);
...
class DecoderContext {
public:
    TORZU_NON_COPYABLE(DecoderContext);
    TORZU_NON_MOVEABLE(DecoderContext);
...
class DecodeApi {
public:
    TORZU_NON_COPYABLE(DecodeApi);
    TORZU_NON_MOVEABLE(DecodeApi);
