...
void Config::Initialize(const std::string& config_name) {
    const std::filesystem::path fs_config_loc = FS::GetTorzuPath(FS::TorzuPath::ConfigDir);
...
void Config::Initialize(const std::optional<std::string> config_path) {
    const std::filesystem::path default_sdl_config_path =
        FS::GetTorzuPath(FS::TorzuPath::ConfigDir) / "sdl2-config.ini";
...
void Config::ReadDataStorageValues() {
    ...
    FS::SetTorzuPath(FS::TorzuPath::NANDDir, ReadStringSetting(std::string("nand_directory")));
    FS::SetTorzuPath(FS::TorzuPath::SDMCDir, ReadStringSetting(std::string("sdmc_directory")));
    FS::SetTorzuPath(FS::TorzuPath::LoadDir, ReadStringSetting(std::string("load_directory")));
    FS::SetTorzuPath(FS::TorzuPath::DumpDir, ReadStringSetting(std::string("dump_directory")));
    FS::SetTorzuPath(FS::TorzuPath::TASDir, ReadStringSetting(std::string("tas_directory")));
...
void Config::ReadScreenshotValues() {
    ...
    FS::SetTorzuPath(FS::TorzuPath::ScreenshotsDir,
...
void Config::SaveDataStorageValues() {
    ...
    WriteStringSetting(std::string("nand_directory"), FS::GetTorzuPathString(FS::TorzuPath::NANDDir),
                       std::make_optional(FS::GetTorzuPathString(FS::TorzuPath::NANDDir)));
    WriteStringSetting(std::string("sdmc_directory"), FS::GetTorzuPathString(FS::TorzuPath::SDMCDir),
                       std::make_optional(FS::GetTorzuPathString(FS::TorzuPath::SDMCDir)));
    WriteStringSetting(std::string("load_directory"), FS::GetTorzuPathString(FS::TorzuPath::LoadDir),
                       std::make_optional(FS::GetTorzuPathString(FS::TorzuPath::LoadDir)));
    WriteStringSetting(std::string("dump_directory"), FS::GetTorzuPathString(FS::TorzuPath::DumpDir),
                       std::make_optional(FS::GetTorzuPathString(FS::TorzuPath::DumpDir)));
    WriteStringSetting(std::string("tas_directory"), FS::GetTorzuPathString(FS::TorzuPath::TASDir),
                       std::make_optional(FS::GetTorzuPathString(FS::TorzuPath::TASDir)));
...
void Config::SaveScreenshotValues() {
    ...
    WriteStringSetting(std::string("screenshot_path"),
                       FS::GetTorzuPathString(FS::TorzuPath::ScreenshotsDir));
