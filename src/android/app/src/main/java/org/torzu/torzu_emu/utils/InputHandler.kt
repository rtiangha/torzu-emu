...
import org.torzu.torzu_emu.features.input.TorzuInputOverlayDevice
import org.torzu.torzu_emu.features.input.TorzuPhysicalDevice

object InputHandler {
    var androidControllers = mapOf<Int, TorzuPhysicalDevice>()
    ...
    fun getDevices(): Map<Int, TorzuPhysicalDevice> {
        val gameControllerDeviceIds = mutableMapOf<Int, TorzuPhysicalDevice>()
            ...
            InputDevice.getDevice(deviceId)?.apply {
                ...
                if (sources and InputDevice.SOURCE_GAMEPAD == InputDevice.SOURCE_GAMEPAD ||
                    ...
                    if (!gameControllerDeviceIds.contains(controllerNumber)) {
                        gameControllerDeviceIds[controllerNumber] = TorzuPhysicalDevice(
                            this,
                            port,
    ...
    fun updateControllerData() {
        ...
        NativeInput.registerController(TorzuInputOverlayDevice(androidControllers.isEmpty(), 100))
